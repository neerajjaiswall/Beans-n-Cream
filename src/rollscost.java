 ...
 * @author HP
 */
public class rollscost extends javax.swing.JFrame {

    /**
     * Creates new form rollscost
     */
    public rollscost() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "     Items                     cost", " ", " egg roll                      50 /-", " cheese roll                   100 /-", " hot bhurji roll               120 /-", " cihcken roll                  120 /-", " mutton roll                   180 /-", " paneer roll                   60 /-", " cheese paneer roll            150 /-", " king paneer roll              50 /-", " ", " ", " ", " " };
        ...
        jScrollPane2.setBounds(140, 210, 550, 400);

        jLabel2.setFont(new java.awt.Font("Gabriola", 1, 60)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("rolls price list");
        jPanel1.add(jLabel2);
        ...
        jButton1.setBounds(350, 730, 140, 50);
        ...
        jButton4.setBounds(770, 10, 30, 30);
        ...
        jButton5.setBounds(730, 10, 30, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rollscost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
