 ...
 * @author HP
 */
public class snackscost extends javax.swing.JFrame {

    /**
     * Creates new form snackscost
     */
    public snackscost() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(340, 730, 150, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(snackscost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new snackscost().setVisible(true);
            }
        });
    }
