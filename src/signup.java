...
//            Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            char b = '"';
            char c = ',';
            String queryfull = "select * from users";
            ...
            String encrypt = "select sha1('" + password + "');";
            res = smt.executeQuery(encrypt);
            res.next();
            String encryptedPassword = res.getString(1);
            
            String query = "insert into users values ("   + (userid+1)+ ",'" + username + "','" + name + "','" 
                    + phoneno + "','" + encryptedPassword + "','" + email + "');";
            smt.executeUpdate(query);
//            int newUserId = userid+1;
//            query = "update users set password = sha1(password) where userid =" + newUserId +";";
