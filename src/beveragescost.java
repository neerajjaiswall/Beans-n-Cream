 ...
 * @author HP
 */
public class beveragescost extends javax.swing.JFrame {

    /**
     * Creates new form beveragescost
     */
    public beveragescost() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(350, 830, 150, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beveragescost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beveragescost().setVisible(true);
            }
        });
    }
